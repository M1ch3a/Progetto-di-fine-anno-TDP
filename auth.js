...
function requireAuth(req, res, next) {
    ...
    if (req.session.user) {
        ...
        res.redirect('/login');
        // Reindirizza alla pagina di login invece di restituire errore 401
        // Così l'utente vede il form di login e può autenticarsi
    }
}
...
/* ============================================ */
// 11. ESPORTA IL ROUTER E I MIDDLEWARE PER USARLI NEL SERVER
/* ============================================ */
...
// Esporta anche requireAuth separatamente
// Serve al server principale per proteggere le route /videogiochi e /simulatori
